	...
	$(document).ready(function() {
		...
		$("button#btnCreateParty").click(function() {
			...
			if(flag) {
				...
				frm.action = "<%= ctxPath %>/createPartyEnd.ottw";
				frm.method = "POST";
				frm.submit();
			}
		...
		<form name="createPartyFrm" style="margin-bottom: 100px;">
			...
			<table id="createPartyTbl" style="margin: auto; width: 680px;">
				...
				<tr>
					...
					<td>
						<input type="text" class="form-control" id="ottid" name="ottid" style="height: 45px; width: 48%; display: inline-block;" placeholder="계정 아이디">
						<span>/</span>
						<input type="text" class="form-control" id="ottpwd" name="ottpwd" style="height: 45px; width: 49%; display: inline-block;" placeholder="계정 비밀번호">
				...
				<tr>
					...
					<td>
						<input type="text" class="form-control" id="partyname" name="partyname" style="height: 45px;" placeholder="제목을 입력하세요">
						<span class="error">필수 입력 정보입니다.</span>
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<span>~</span>
						<input type="date" class="form-control" id="enddate" name="enddate" style="height: 45px; width: 36%; display: inline-block;" min="2022-05-07">
				...
				<tr>
					...
					<td>
						<input type="number" class="form-control" id="nop" name="nop" style="height: 45px;" min="1" max="10" value="1"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" class="form-control" id="charge" name="charge" style="height: 45px; width: 76%; display: inline-block;" placeholder="1인당 일일요금 * 진행일수 * 모집인원">
				...
				<tr>
					<td colspan="2">
						<button type="button" id="btnCreateParty" class="w-100 mt-3 py-1">파티 만들기</button>
					</td>
				</tr>
			</table>
